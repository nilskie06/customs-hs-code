...
// @ph-itdev/customs-hs-code CLI
// Usage: npx @ph-itdev/customs-hs-code playground
...
if (command === 'playground' || command === 'demo' || command === 'play') {
  ...
  Commands:
    npx @ph-itdev/customs-hs-code playground   Open interactive playground in browser
    npx @ph-itdev/customs-hs-code demo         Same as playground
    npx @ph-itdev/customs-hs-code help          Show this help
  `);
} else {
...
function startPlayground() {
  ...
  if (!fs.existsSync(examplePath)) {
    console.error('❌ Example file not found. Try: npm install @ph-itdev/customs-hs-code');
    process.exit(1);
  }
  ...
  server.listen(PORT, '127.0.0.1', () => {
    ...
    console.log(`
  📦 @ph-itdev/customs-hs-code — Playground running!
